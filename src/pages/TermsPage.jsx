    ...
    >
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-surface rounded-2xl p-6 border border-gray-800 space-y-4 text-sm text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-white mb-2">Use of Service</h2>
            <p>
              This service is provided for entertainment purposes. Facial comparison results
              are algorithmic approximations and should not be used for identity verification
              or any legal purpose.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You must only upload photos of yourself or photos for which you have consent
              from the person depicted. Uploading photos of others without their consent is
              prohibited.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              This service is provided &quot;as is&quot; without warranties. We are not responsible
              for the accuracy of comparison results or any decisions made based on them.
            </p>
          </section>
        </div>
      </div>
